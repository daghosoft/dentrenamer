...
public class RenamerServiceImplTest {
	...
	@Test
	public void rename() {
		String out = sut.rename(
				" ita Storia di un italiano -Il.Gatto.Con.Gli.Stivali.2011-.iTALiAN.BDRip.XviD-Twice.2011.avi ", true);
	...
	public void removeMultipleHyphenTest() {
		String out = sut.removeMultipleHyphen(
				" 3 Il Gatto Con Gli Stivali 2011 - - - -      - -  - - - - - - -   -    -   -   ");
		assertThat(out).isEqualTo("3 Il Gatto Con Gli Stivali 2011 -");
	}
